  ...
  <header class="sticky top-0 z-50 backdrop-blur bg-slate-900/70 border-b border-white/10">
    <nav class="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        <button class="md:hidden inline-flex items-center justify-center rounded-md p-2 ring-1 ring-white/20"
          @click="isOpen = !isOpen" aria-label="Navigation öffnen">
    ...
    <transition name="fade">
      <div v-if="isOpen" class="md:hidden border-t border-white/10 bg-slate-900/90 backdrop-blur px-4 pb-4">
