        ...
        <div class="mx-auto max-w-6xl space-y-8">
            ...
            <section class="space-y-3">
                ...
                <p class="text-xs sm:text-sm text-white/70">
                    Bei Fragen:
                    <a href="mailto:optilagerdavos@gmail.com" class="text-sky-400 hover:underline">
            ...
            <section
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6">
                    ...
                    <div class="flex flex-col items-start sm:items-end gap-1">
                        ...
                        <p v-if="children.length" class="text-[11px] text-white/50 flex flex-col gap-1">
                    ...
                    <div class="grid gap-8 lg:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            <h2 class="text-sm font-semibold tracking-wide">
                                Segler/in
                                <span v-if="editingIndex !== null" class="ml-2 text-[11px] text-sky-400">
                                    (Bearbeitung)
                                </span>
                            </h2>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input v-model="sailor.firstName"
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input v-model="sailor.lastName"
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>

                            <div class="space-y-1.5">
                                <label class="text-xs font-medium"> Geburtsdatum* </label>
                                <input type="date" v-model="sailor.birthdate"
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="flex flex-wrap gap-3 text-xs">
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="m" v-model="sailor.gender" class="accent-sky-500" />
                                        Männlich
                                    </label>
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="w" v-model="sailor.gender" class="accent-sky-500" />
                                        Weiblich
                                    </label>
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="d" v-model="sailor.gender" class="accent-sky-500" />
                                        Divers
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input v-model="sailor.ahv" @input="ahvValid = isValidAhv(sailor.ahv)"
                                    placeholder="756.1234.5678.97"
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2"
                                    :class="ahvValid ? 'focus:ring-green-500 border-green-500' : 'focus:ring-red-500 border-red-500'" />

                                <p v-if="!ahvValid && sailor.ahv" class="text-[11px] text-red-400">
                                    Ungültige AHV-Nummer (muss 13 Stellen haben & korrekt berechnet sein)
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                ...
                                <div class="flex gap-4 text-xs">
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="yes" v-model="sailor.wasInCamp"
                                            class="accent-sky-500" />
                                        Ja
                                    </label>
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="no" v-model="sailor.wasInCamp"
                                            class="accent-sky-500" />
                                        Nein
                                    </label>
                                </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="flex flex-col gap-1.5 text-xs">
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="normal" v-model="sailor.diet"
                                            class="accent-sky-500" />
                                        Normalkost
                                    </label>
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="vegetarisch" v-model="sailor.diet"
                                            class="accent-sky-500" />
                                        Vegetarisch
                                    </label>
                                    <label class="inline-flex items-center gap-1.5">
                                        <input type="radio" value="vegan" v-model="sailor.diet"
                                            class="accent-sky-500" />
                                        Vegan
                                    </label>
                                </div>
                            ...
                            <div class="relative">
                                <textarea v-model="sailor.comment" rows="6" maxlength="400"
                ...
                <form v-else class="space-y-6" @submit.prevent="submitForm">
                    <div class="grid gap-8 lg:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-1.5">
                                <label class="text-xs font-medium"> Vorname* </label>
                                <input v-model="parent.firstName" required
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>

                            <div class="space-y-1.5">
                                <label class="text-xs font-medium"> Nachname* </label>
                                <input v-model="parent.lastName" required
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>

                            <div class="space-y-1.5">
                                <label class="text-xs font-medium"> Adresse* </label>
                                <input v-model="parent.address" required
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div class="space-y-1.5">
                                    ...
                                    <input v-model="parent.zip" required
                                        class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                                </div>
                                <div class="sm:col-span-2 space-y-1.5">
                                    <label class="text-xs font-medium"> Ort* </label>
                                    <input v-model="parent.city" required
                                        class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                ...
                                <input v-model="parent.emergencyPhone" required
                                    class="w-full rounded-md bg-white text-slate-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <label class="inline-flex items-center gap-2 text-xs">
                                    <input type="checkbox" v-model="parent.acceptTerms" required
                                        class="accent-sky-500" />
